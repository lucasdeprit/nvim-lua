...
_G.packer_plugins = {
  ...
  rnvimr = {
    loaded = true,
    path = "/home/luak/.local/share/nvim/site/pack/packer/start/rnvimr",
  ...
  ["toggleterm.nvim"] = {
    loaded = true,
    path = "/home/luak/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
  ...
  ["vim-wakatime"] = {
    loaded = true,
    path = "/home/luak/.local/share/nvim/site/pack/packer/start/vim-wakatime",
